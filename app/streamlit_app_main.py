...
with st.sidebar:
    st.write('**Telecom Network RCA and Remediation Copilot**')


pages = [
    st.Page(page = PAGE_1_PATH, title = 'Telecom Network Dashboard', icon = '📡'),
    st.Page(page = PAGE_2_PATH, title = 'Root Cause Dashboard', icon = '🔎'),
    st.Page(page = PAGE_3_PATH, title = 'Remediation Dashboard', icon = '🛠️'),
    st.Page(page = PAGE_4_PATH, title = 'Auto Resolution Dashboard', icon = '💊'),
    st.Page(page = PAGE_5_PATH, title = 'Ticket Management Dashboard', icon = '🐞')
]
